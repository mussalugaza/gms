...
<?php if ($this->newLink): ?>
  <div class="horde-new tr_sidenew">
<?php if ($this->newExtra): ?>
    <div class="horde-new-extra"><?php echo $this->newExtra ?>&nbsp;</a></div>
    <div class="horde-new-split"></div>
<?php endif ?>
    <span class="horde-new-link tr_new"><?php echo $this->newLink ?><?php echo $this->newText ?></a></span>
  </div>
<?php endif ?>
...
<div id="horde-slideleft" class="horde-splitbar-vert" style="left:220px !important">
