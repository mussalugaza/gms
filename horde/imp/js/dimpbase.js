...
// Here is some code to handle copyright issue 

var d1 = document.getElementById('horde-body');

d1.insertAdjacentHTML('afterend', '<div id="copyright-text-footer" style="text-align:center;position: absolute;bottom: 0;left: 0;font-size: 12px;z-index:9999; width: 100%;background-color: #99bae9;padding-top: 4px;padding-bottom: 4px;height: 10px;-moz-box-shadow: inset 0 0 10px #000000; -webkit-box-shadow: inset 0 0 10px #93b6e8; box-shadow: inset 0 0 10px #90b3e7">Copyright  &copy; ' + new Date().getFullYear() + '<a href="http://ega.go.tz" target="_blank"> e-GA.</a>| All rights reserved. | GMS ver 2.0</div>');
