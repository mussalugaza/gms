...
$cfgSources['localsql'] = array(
    // ENABLED by default
    'disabled' => false,
    'title' => _("Collected Address Books"),
    'type' => 'sql',
    'params' => array(
...
$domainname= $domainarray[$index-2].".".$domainarray[$index-1].".".$domainarray[$index];
...
$cfgSources['localldap'] = array(
    // Disabled by default
    'disabled' => false,
    'title' => _("Shared E-Mail Addresses"),
    'type' => 'ldap',
    'params' => array(
        'server' => '10.1.2.100',
        'port' => 389,
        'tls' => false,
        'root' => 'ou=Users,domainName="'.$vdomain.'",o=domains,dc=gov,dc=go,dc=tz',
        'bind_dn' => 'cn=vmailadmin,dc=gov,dc=go,dc=tz',
        // For Active Directory:
        // 'bind_dn' => 'username@example.com',
        'bind_password' => 'Re9qgfAsJwagNYSOHCamg27xyqNx0e',
        'sizelimit' => 200,
        // For Active Directory:
        // 'sizelimit' => 0,
        'dn' => array('mail'),
...
$cfgSources['ldapgroup'] = array(
    'disabled' => false,
    'title' => _("Group E-mail Addresses"),
    'type' => 'ldap',
    'params' => array(
        'server' => '10.1.2.100',
        'port' => 389,
        'tls' => false,
        'root' => 'ou=Groups,domainName="'.$vdomain.'",o=domains,dc=gov,dc=go,dc=tz',
        'bind_dn' => 'cn=vmailadmin,dc=gov,dc=go,dc=tz',
		//'filter' => '&(memberOfGroup=group.dcio@ega.go.tz)',
        'bind_password' => 'Re9qgfAsJwagNYSOHCamg27xyqNx0e',
        'sizelimit' => 200,
        'dn' => array('cn'),
       /* 'objectclass' => array('top',
                               ...
                               'turbaContact',
                                'calEntry'), */
"objectclass" => array (  "organizationalPerson",   "top",   "user",  "group",   "person",   "contact", "turbaContact",   "hordeGroup" ,  "Group",   "calEntry",'mail' ),
        'scope' => 'sub',
        'charset' => 'utf-8',
        'checkrequired' => false,
        'checkrequired_string' => ' ',
...
/*
$cfgSources['ldapgroup1'] = array(
    'disabled' => false,
    'title' => _("Groups E-Mail Addresses"),
    'type' => 'ldap',
    'params' => array(
        'server' => '10.1.2.100',
        'port' => 389,
