    ...
    public function __construct()
    {
        ...
        if ($session->get('imp', 'rteavail')) {
            ...
            $page_output->addInlineScript(array(
                ...
                //  'CKEDITOR.config.scayt_srcUrl = "https://wsc.gov.go.tz/spellcheck/lf/scayt/scayt.js"'.
                'CKEDITOR.config.scayt_srcUrl = "https://wsc.gov.go.tz/spellcheck/lf/scayt3/scayt/scayt.js"'.
                '}); };'
            ), true);
        }
    }
