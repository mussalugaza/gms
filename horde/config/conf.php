...
//ini_set('include_path', '.:/usr/share/pear:/pear/lib:/var/www/pear/lib');
...
$conf['secret_key'] = 'z14GCNsB19wLVw-zhyK6Aii';
$conf['umask'] = 077;
...
$conf['sql']['password'] = 'horde@20_17';
$conf['sql']['hostspec'] = '10.1.2.100';
$conf['sql']['port'] = 3306;
...
$conf['auth']['admins'] = array('denis.bahati@ega.go.tz', 'kambey.lotoishe@ega.go.tz', 'peter.wangwe@ega.go.tz', 'rashid.ndimbo@ega.go.tz', 'postmaster@gov.go.tz', 'ramadhani.mdachi@ega.go.tz','solomon.stanley@ega.go.tz', 'mussa.lugaza@ega.go.tz');
