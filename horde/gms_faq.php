...
if ($browser->isMobile() &&
    ...
    $page_output->addScriptFile("../ega_customs/js/jquery.min.js");
    $page_output->addScriptFile("../ega_customs/js/bootstrap.min.js");
    ...
    require $registry->get('templates', 'horde') . '/login/gms_faq.inc';
}
